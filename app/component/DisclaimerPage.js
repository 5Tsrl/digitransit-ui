...
const DisclaimerPage = ({ currentLanguage }, context) => {
  const about = context.config.disclaimerPage[currentLanguage];
  return (
...
DisclaimerPage.contextTypes = {
  config: PropTypes.object.isRequired,
};

export default connectToStores(DisclaimerPage, ['PreferencesStore'], context => ({
